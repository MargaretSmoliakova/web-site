...
(function() {
    ...
    function deliveryDate (today) {
        ...
        dayFromToday = new Date (today.getTime() + 5 * 24 * 60 * 60 *1000);
        ...
        if (day === 'Вторник') {
            var elAt = document.getElementById('at_1');
            elAt.innerHTML = 'во ';
        }
    ...
    today = new Date();
    elDeliveryDateMsg = document.getElementById('body_delivery_1_time');
